      ...
      <Link to={"/games/k3"}>
        <div className="bg-[#595959] rounded-lg">
          <div className="relative card-3d shine-effect p-4 flex flex-col">
            <div>
              <h3 className="text-lg font-bold text-white card-title">K3</h3>
              <p className="text-sm text-white mt-1">🎲 Roll, Bet, Win Big!</p>
              <p className="text-sm text-white mt-1">
                ⚡ Fast-Paced Dice Thrill!
              </p>
            </div>
            ...
            <img
              src={Lottery_K3}
              alt="Corner Icon"
              className="absolute top-[-10px] right-[-10px] w-[100px] h-[70px] floating-img"
            />
          </div>
